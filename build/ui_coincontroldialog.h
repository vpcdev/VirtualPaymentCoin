...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 VPC"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 VPC"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 VPC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 VPC"));

...
{
    resize(900, 520);
    setWindowTitle(tr("Virtualpayment") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("virtualpayment");
    setStyleSheet("#virtualpayment { background-color:#ffffff;  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Virtualpayment address"));
    ...
    aboutAction = new QAction(tr("&About Virtualpayment"), this);
    aboutAction->setToolTip(tr("Show information about Virtualpayment"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Virtualpayment"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Virtualpayment client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Virtualpayment client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Virtualpayment network", "", count));
}
...
{
    QString strTitle = tr("Virtualpayment") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Virtualpayment address or malformed URI parameters."));
    }

...
static const int64_t STATIC_POS_REWARD = 1 * COIN; //Constant reward of 1 VPC per COIN
...
static const int64_t MAX_MONEY = 10000000 * COIN; // 1B Max supply VPC
...
inline int64_t GetMNCollateral(int nHeight) { return 100000; } //100.000 Colletral
